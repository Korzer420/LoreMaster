...
internal class TreasureHunterPower : Power
{
    ...
    {
        orig(self);
        if (self.IsCorrectContext("npc_control", null, "In Range") && self.Fsm.FsmComponent.GetComponent<DoorNameMarker>() is DoorNameMarker door)
    ...
    private void MoreDoorsPreview(string doorName)
    {
        ...
        playMakerFSM.FsmVariables.GetFsmString("Convo Title").Value = "Master_Key_Preview-"+ placement.Name;
