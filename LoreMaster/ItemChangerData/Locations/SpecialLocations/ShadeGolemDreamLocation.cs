...
internal class ShadeGolemDreamLocation : DreamNailLocation
{
    ...
    private void CheckGolemState(PlayMakerFSM fsm)
    {
        ...
        if(name.Contains("01") && fsm.GetState("Destroy") is FsmState state && !Placement.Items.All(x => x.IsObtained()))
        ...
        else if (name.Contains("02") && fsm.FsmVariables.FindFsmString("playerData bool").Value == "gotShadeCharm"
