...
public class RandomizerMenu
{
    ...
    private void ConstructMenu(MenuPage previousPage)
    {
        try
        {
            ...
            new VerticalItemPanel(_mainPage, new(400, 350), 50f, true, _menuElementFactory.Elements.Skip(6).Take(5).ToArray());
            ...
            if (!RandomizerManager.Settings.RandomizeTreasures)
                _menuElementFactory.Elements[10].Hide();
            ...
            _menuElementFactory.Elements[9].SelfChanged += CompassVisiblity;
            new VerticalItemPanel(_mainPage, new(0, -0f), 50f, true, _menuElementFactory.Elements.Skip(11).Take(2).ToArray());
            _menuElementFactory.Elements[13].MoveTo(new(-350f, -200f));
            _menuElementFactory.Elements[13].SelfChanged += ChangeEndCondition;
            _menuElementFactory.Elements[14].MoveTo(new(-350f, -275f));
            _menuElementFactory.Elements[14].SelfChanged += CheckLoreCap;
            if (RandomizerManager.Settings.BlackEggTempleCondition == BlackEggTempleCondition.Dreamers)
                _menuElementFactory.Elements[14].Hide();
            _menuElementFactory.Elements[15].MoveTo(new(350f, -200f));
            _menuElementFactory.Elements[15].SelfChanged += ShowPowerButton;
    ...
    private void AdjustLorePool(IValueElement obj)
    {
        ...
        if (RandomizerManager.Settings.BlackEggTempleCondition != BlackEggTempleCondition.Dreamers && AvailableLore() < RandomizerManager.Settings.NeededLore)
            _menuElementFactory.Elements[14].SetValue(AvailableLore());
    }
    ...
    {
        if ((bool)obj.Value)
            _menuElementFactory.Elements[10].Show();
        else
            _menuElementFactory.Elements[10].Hide();
    }
    ...
    private void ChangeEndCondition(IValueElement obj)
    {
        if ((BlackEggTempleCondition)obj.Value != BlackEggTempleCondition.Dreamers)
            _menuElementFactory.Elements[14].Show();
        else
            _menuElementFactory.Elements[14].Hide();
    }
