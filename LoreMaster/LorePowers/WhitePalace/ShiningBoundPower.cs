...
public class ShiningBoundPower : Power
{
    ...
    {
        CustomText = "When the Wyrm arrised, all kinds of powerful relics were shattered around the world. If we could be assembled again, the energy would flood through us again.";
