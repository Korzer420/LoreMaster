...
internal class InspectLocation : ContainerLocation
{
    ...
    protected override void OnLoad()
    {
        ...
        { 
            ...
            Events.AddFsmEdit(sceneName, new($"{name} Inspect", "inspect_region"), ModifyInspectRegion);
        }
        else
    ...
    protected override void OnUnload()
    {
        if (string.IsNullOrEmpty(GameObjectName))
        {
            ...
            Events.RemoveFsmEdit(sceneName, new($"{name} Inspect", "inspect_region"), ModifyInspectRegion);
        }
        else
